...
def main(client_log_path, serving_log_path, batch_size, model_name, runtime):
    """
    Analyze inference results
    """
    speed_processing_picture_client, batch_num = _speed_of_client(client_log_path, batch_size)
    speed_processing_picture_serving, batch_num1, serving_runtime = _speed_of_serving(serving_log_path, batch_size)
    ...
    print(f'Model: {model_name}, Runtime: {serving_runtime}')
...
if __name__ == '__main__':
    ...
    parser.add_argument('-m', '--client-log-path', type=str, required=True,
                        help='The path of client log')
    parser.add_argument('-s', '--serving-log-path', type=int, required=True,
    ...
    main(args.client_log_path, args.serving_log_path, args.batch_size, args.model_name, args.runtime)
